...
RcppDMI <- function(target, tau, pred, k = 3L, alg = 0L, base = 2.0, na_comp = TRUE, normalize = FALSE, threads = 1L) {
    .Call(`_pc_RcppDMI`, target, tau, pred, k, alg, base, na_comp, normalize, threads)
}

RcppFNN <- function(target, rt, eps, lib, pred, E, tau = 1L, style = 0L, dist_metric = "euclidean", k = 3L, threads = 1L, parallel_level = 0L, nb = NULL, nrows = NULL, na_comp = TRUE) {
